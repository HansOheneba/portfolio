...
export default function LiftoffWeddingCaseStudy() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#070A12] text-white">
      {/* Ambient background */}
      <GlowBlob className="left-[-12%] top-[-10%] h-[420px] w-[420px] bg-sky-400" />
      <GlowBlob className="right-[-18%] top-[18%] h-[520px] w-[520px] bg-indigo-400" />
      <GlowBlob className="left-[18%] bottom-[-18%] h-[520px] w-[520px] bg-slate-400" />
      ...
      <div className="relative mx-auto max-w-4xl px-6 py-16 md:py-20 space-y-10">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
            Liftoff Wedding Website
          </h1>

          <p className="text-lg text-white/70 leading-relaxed">
            I built Liftoff as a wedding website for a couple deeply connected
            to aviation and military aviation. The design direction leaned into
            themes of precision, launch, and structured elegance while still
            feeling warm and celebratory.
          </p>

          <p className="text-white/70 leading-relaxed">
            The platform delivered a clear mission-style flow: event details,
            RSVP capture, and a seamless “add to calendar” integration so guests
            could lock in the date instantly. The experience was built to feel
            confident, organized, and smooth across devices.
          </p>

          <Link
            href="https://liftoff.hansoheneba.com/"
            target="_blank"
        ...
        <div className="text-xs text-white/45">
          Built as a custom aviation-themed wedding website with RSVP and
